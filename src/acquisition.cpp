...
void TwoCorrelationPeakComparison(float* correlationMap, size_t sizeMap, int* r_idxPeak, float* r_acqMetric) {
...
int FindMaxIndex(float* array, size_t size, int excludeIdx){
    int idxMax = 0; 
    if (excludeIdx == 0){
        idxMax = 1;
    }
